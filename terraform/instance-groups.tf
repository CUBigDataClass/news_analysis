...
resource "google_compute_instance_group" "eu-elastic-ig-zone-b" {
  name = "eu-elastic-ig-zone-b"
  network = google_compute_network.my-elastic-network.self_link
  instances = [
...
resource "google_compute_instance_group" "eu-kibana-ig-zone-a" {
  name = "eu-kibana-ig-zone-a"
  network = google_compute_network.my-elastic-network.self_link
